...
public class DataLinkerView extends UserDataView {
    ...
    public DataLinkerView(String theName, UserDataModel theModel,
            UserDataTupleType theTuple) {
        this.name = theName;
        this.model = (DataLinkerModel) theModel;
        this.tuple = theTuple;
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (window == null || window.isDisposed()) {
                    ...
                    window = new DataLinkerWindow(DataLinkerView.this);
