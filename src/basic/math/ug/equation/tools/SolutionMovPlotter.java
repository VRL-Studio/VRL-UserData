...
/**<p>
 * SolutionMovPlotter shows after calculation the evolution of the solution.
 * </p>
 * SolutionMovPlotter loads the plot files which was generated by each timestep of
...
public class SolutionMovPlotter implements Serializable {
    ...
    private String generateFileName(int index) {
        return UGVariables.UGROOT + "/plot" +
                index + ".txt";
    }
    ...
    interactive = true, valueStyle = "mov")
